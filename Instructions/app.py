...
def homepage():
    ...
    title = "The coolest study of biodiversity on the human body on the planet!"
    paragraph2 = "This project was inspired by Rob Dunn Lap." 
    paragraph3 ="To investigate the microbes inhabiting our navels and the factors that might influence the microscopic life."
    paragraph4 = "Belly Button Biodiversity inspired conversations about the beneficial roles microbes play in our daily lives."
